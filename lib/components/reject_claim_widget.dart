...
export 'reject_claim_model.dart';
...
class _RejectClaimWidgetState extends State<RejectClaimWidget> {
  late RejectClaimModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RejectClaimModel());
