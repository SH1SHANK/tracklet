...
class FilterDropdownWidget extends StatefulWidget {
  ...
  final Future Function(String filterBy)? filterCallBack;
  final String? activeFilter;
  final Future Function()? clearFilterCallback;
          ...
          children: [
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () async {
                  await widget.filterCallBack?.call(
                    'found',
                  );
                },
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        if (widget.activeFilter == 'found')
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 0.0, 12.0, 0.0),
                            child: Icon(
                              FFIcons.kcheckFatBold,
                              color: FlutterFlowTheme.of(context).primaryText,
                              size: 20.0,
                            ),
                          ),
            ...
            Padding(
              ...
              child: InkWell(
                ...
                highlightColor: Colors.transparent,
                onTap: () async {
                  await widget.clearFilterCallback?.call();
                },
                child: Container(
                  width: double.infinity,
                  decoration: BoxDecoration(
