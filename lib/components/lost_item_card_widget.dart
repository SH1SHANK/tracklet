...
import '/components/claim_item_widget.dart';
import '/components/found_item_widget.dart';
...
class _LostItemCardWidgetState extends State<LostItemCardWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ClaimsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ClaimsRow> containerClaimsRowList = snapshot.data!;
