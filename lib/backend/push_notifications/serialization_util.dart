...
T? getParameter<T>(Map<String, dynamic> data, String paramName) {
  try {
    ...
    switch (T) {
      ...
      case FeedItemsRow:
        return FeedItemsRow(json.decode(param) as Map<String, dynamic>) as T;
      case ClaimsRow:
        return ClaimsRow(json.decode(param) as Map<String, dynamic>) as T;
      case FeedFoundItemsRow:
        return FeedFoundItemsRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case FlagsRow:
        return FlagsRow(json.decode(param) as Map<String, dynamic>) as T;
      case UserItemsSummaryRow:
        return UserItemsSummaryRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case ActiveItemsRow:
        return ActiveItemsRow(json.decode(param) as Map<String, dynamic>) as T;
      case ClaimMessagesRow:
        return ClaimMessagesRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case FeedLostItemsRow:
        return FeedLostItemsRow(json.decode(param) as Map<String, dynamic>)
            as T;
      case CategoriesRow:
        return CategoriesRow(json.decode(param) as Map<String, dynamic>) as T;
      case ItemsRow:
        return ItemsRow(json.decode(param) as Map<String, dynamic>) as T;
    }
    if (param is String) {
