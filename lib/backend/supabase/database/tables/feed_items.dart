...
class FeedItemsTable extends SupabaseTable<FeedItemsRow> {
  @override
  String get tableName => 'feed_items';

  @override
  FeedItemsRow createRow(Map<String, dynamic> data) => FeedItemsRow(data);
}

class FeedItemsRow extends SupabaseDataRow {
  FeedItemsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => FeedItemsTable();
