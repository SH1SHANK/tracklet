...
class FeedLostItemsTable extends SupabaseTable<FeedLostItemsRow> {
  @override
  String get tableName => 'feed_lost_items';

  @override
  FeedLostItemsRow createRow(Map<String, dynamic> data) =>
      FeedLostItemsRow(data);
}

class FeedLostItemsRow extends SupabaseDataRow {
  FeedLostItemsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => FeedLostItemsTable();
