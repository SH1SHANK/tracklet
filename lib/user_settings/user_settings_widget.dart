...
import '/components/delete_user_account_widget.dart';
import '/custom_dialogs/change_display_name/change_display_name_widget.dart';
import '/custom_dialogs/change_password/change_password_widget.dart';
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              onTap: () async {
                                await launchURL(
                                    'https://github.com/sh1shank/tracklet');
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                mainAxisAlignment:
                            ...
                            Row(
                              ...
                              children: [
                                Align(
                                  alignment: AlignmentDirectional(-1.0, 0.0),
                                  child: Text(
                                    'v0.0.1 internal-alpha-testbuild1',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          font: GoogleFonts.outfit(
